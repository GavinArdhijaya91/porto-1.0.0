    ...
    return (
        <>
            <motion.nav
                ...
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled || menuOpen ? 'bg-glass-nav shadow-lg shadow-black/20' : 'bg-transparent md:bg-transparent bg-glass-nav'
                    }`}
            >
